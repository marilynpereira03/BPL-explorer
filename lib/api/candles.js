        ...
        function (err, results) {
            if (err) {
                ...
                var statistics = {
                    ...
                    arkVolume : _.reduce(results[0], function (memo, t) { return (memo + parseFloat(t.arkVolume)); }, 0.0).toFixed(8),
                ...
                statistics = {
                    ...
                    arkVolume : statistics.arkVolume,
